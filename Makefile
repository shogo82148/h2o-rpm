SOURCE_ARCHIVE := 706842c0f8c0d9422efb97a4d8ef7d6ec9df87b7.tar.gz
WSLAY_VERSION := 1.1.1
...
.PHONY: all
all: amazonlinux2 amazonlinux2023 almalinux8 rockylinux8 almalinux9 rockylinux9 almalinux10 rockylinux10
...
rpmbuild/SOURCES/$(BROTLI_SOURCE_ARCHIVE):
	curl -sSL https://github.com/google/brotli/archive/refs/tags/v$(BROTLI_VERSION).tar.gz -o rpmbuild/SOURCES/$(BROTLI_SOURCE_ARCHIVE)
...
.PHONY: test
test: test-amazonlinux2 test-amazonlinux2023 test-almalinux8 test-almalinux9 test-almalinux10 test-rockylinux8 test-rockylinux9 test-rockylinux10
...
.PHONY: test-almalinux10
test-almalinux10:
	./scripts/test.sh almalinux10
...
.PHONY: test-rockylinux10
test-rockylinux10:
	./scripts/test.sh rockylinux10
...
clean:
	...
	docker rmi $(IMAGE_NAME)-almalinux10 || true
	...
	docker rmi $(IMAGE_NAME)-rockylinux10 || true
